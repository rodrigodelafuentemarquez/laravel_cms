      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Usuarios">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMedia">
            <li>
                <a href="{{route('admin.media.index')}}">Archivo</a>
            </li>
            <li>
                <a href="{{route('admin.media.create')}}">Subir imágenes</a>
            </li>
          </ul>
          <!-- /.nav-second-level -->
        </li>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="{{ url('/admin/profile') }}/{{auth()->user()->id}}"><i class="fa fa-user fa-fw"></i> User Profile</a>
            <div class="dropdown-divider"></div>
